    ...
    <div className="content-wrapper">
      ...
      <div className="content">
        <div className="content-item">
          <img src="/pratice-react/img/event_page1.jpg" alt="" />
        </div>
        <div className="content-item">
          <div className="article">
            ...
            <div className="button-content">
              <Link to={'/pratice-react/Product'} className='link-button'><button>Shop now</button></Link>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="content">
        ...
        <div className="content-item">
          <img src="/pratice-react/img/event_page2.jpg" alt="" />
        </div>
      ...
      {/* 3 */}
      <div className='gift'>
          <img src="/pratice-react/img/event_page3.jpg" alt="" />
