...
export default function Model() {
  ...
  const hangleSignIn = async () => {
    const findUser = await login(email, password);
    if (findUser) {
      setUser(findUser);
      setEmail("");
      setPassword("");
        ...
        <div className="model-content">
          {
            status === "sign-in" ?
                  ...
                  <div className="group">
                    ...
                    <div className="box-forgot-password">
                      <div className="sign-up">
                        ...
                        <div style={{ cursor: 'pointer' }} onClick={() => setStatus("sign-up")}>
                          sign up
                        </div>
                      </div>
              ...
              status === "sign-up" ?
                <ModelSignUp  setStatus={ setStatus} setEmailSignIn = {setEmail}></ModelSignUp> :
                ''
          }
        </div>
      </div>
