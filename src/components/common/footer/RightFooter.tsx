...
export default function RightFooter() {
  ...
  return (
    <div className="promotions">
      ...
      <div className="icon">
          <img src="/pratice-react/phosphor-Twitter.svg" alt="" />
          <img src="/pratice-react/phosphor-facebook.svg" alt="" />
          <img src="/pratice-react/phosphor-Linkedin.svg" alt="" />
          <img src="/pratice-react/phosphor-Youtube.svg" alt="" />
      </div>
      <div className="brand">
